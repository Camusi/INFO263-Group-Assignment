...
<head>
    ...
    <title>constantine | IMDB2.0</title>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
    <script src="../resources/search.js"></script>
    <meta type="description" content="Checkout constantine on IMDB2, your home of all things media." />
    <meta name="keywords" content="constantine, IMDB, movies, shows, people, media, database" />
...
<body>
    <header class="header">
        <h1>IMDB2.0</h1>
        <p id="user-name">constantine's Profile</p>
    </header>
    <?php include '../resources/navbar.php'; ?>
    <main class="title-page-info">
        <div class="left-column">
            <div id="user-likes">
                <h1>Pages that <em>constantine</em> Likes</h1>
                    <?php echo $likedPagesHTML; ?>
            </div>
            <div id="user-dislikes">
                <h1>Pages that <em>constantine</em> Dislikes</h1>
                    <?php echo $dislikedPagesHTML; ?>
            </div>
        </div>

        <aside id="blurb">
            <p id="blurb-text">constantine has liked <?php echo $pagesLikeCount; ?> pages and dislikes <?php echo $pagesDislikeCount; ?> pages.</p>
        </aside>
    </main>
    <div id="comments"></div>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  images.forEach(img => {
    $.ajax({
      url: `../resources/cover-image.php?q=constantine`,
      method: 'GET',
      dataType: 'json',
      async: false,
